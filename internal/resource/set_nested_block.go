...
func NewGeneratorSetNestedBlock(name string, b *resource.SetNestedBlock) (GeneratorSetNestedBlock, error) {
	...
	pms := convert.NewPlanModifiers(convert.PlanModifierTypeSet, b.PlanModifiers.CustomPlanModifiers())
...
func (g GeneratorSetNestedBlock) CustomTypeAndValue(name string) ([]byte, error) {
	...
	objectValue := schema.NewCustomNestedObjectValue(name, attributesBlocksTypes, attributesBlocksAttrTypes, attributesBlocksAttrValues, attributeNestedAttrTypes, attributeCollectionTypes)
